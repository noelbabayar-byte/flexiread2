...
class Settings(BaseSettings):
    ...
    DB_PASSWORD: str = Field(default="flexiread_dev_password", description="Database password")
    ...
    REDIS_PASSWORD: str = Field(default="flexiread_redis_dev", description="Redis password")
    ...
    CELERY_WORKER_CONCURRENCY: int = Field(default=1, description="Celery worker concurrency")
    ...
    JWT_REFRESH_EXPIRATION_DAYS: int = Field(default=7, description="JWT refresh expiration days")
    ...
    PUBLIC_S3_URL: Optional[str] = Field(
        default=None,
        description="Public S3 URL (for presigned URLs)"
    )
    ...
    # ========================================================================
    FREE_TIER_MONTHLY_QUOTA: int = Field(default=50, description="Free tier monthly quota")
    PRO_TIER_MONTHLY_QUOTA: int = Field(default=1000, description="Pro tier monthly quota")
    ...
    # Feature Flags
    # ========================================================================
    FEATURE_OFFLINE_READING: bool = Field(default=True, description="Offline reading feature")
